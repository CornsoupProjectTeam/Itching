...
class ProjectInfo(db.Model):
    ...
    public_profile = db.relationship('PublicProfile', backref=db.backref('projects_info', lazy=True))
    field_keywords = db.relationship('FieldKeywords', backref=db.backref('projects', lazy=True))
